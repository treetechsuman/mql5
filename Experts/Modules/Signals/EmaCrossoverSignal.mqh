#ifndef EMACROSSOVERSIGNAL_MQH
#define EMACROSSOVERSIGNAL_MQH

string EmaCrossoverSignal(int emaFastPeriod,int emaSlowPeriod){
   //create an array for several prices
   double emaFastAverageArray[],emaSlowAverageArray[];
   ...
   if(
      (emaFastAverageArray[0]>emaSlowAverageArray[0])
      &&(emaFastAverageArray[1]<emaSlowAverageArray[1])
   ){
      //Comment("BUY");
      return "BUY";
   }
